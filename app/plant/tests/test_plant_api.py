...
def image_upload_url(plant_id):
    """Create and return an image upload URL."""
    return reverse('plant:plant-upload-image', args=[plant_id])
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client.force_authenticate(self.user)
        self.plant = create_plant(user=self.user)

    def tearDown(self):
        self.plant.image.delete()

    def test_upload_image(self):
        """Test uploading an image to a plant."""
        url = image_upload_url(self.plant.id)
        ...
        self.assertTrue(os.path.exists(self.plant.image.path))
